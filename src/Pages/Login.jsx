...
import SocialLogin from "../Components/useHooks/SocialLogin";
    ...
    <div className="md:py-10 ">
      <div className=" rounded-xl max-w-7xl mx-auto">
        <div className="flex flex-col p-3  md:flex-row items-center justify-center gap-20">
          ...
          <div className="border w-full rounded-lg border-orange-200 font-hebo md:w-1/3 p-10">
            ...
            <div className="mt-8">
              <form onSubmit={handleLogin}>
                ...
                <button
                  type="submit"
                  className="bg-orange-400 disabled:bg-orange-200 text-white uppercase w-full py-2 rounded"
                >
                  Sign in
                </button>
              </form>
